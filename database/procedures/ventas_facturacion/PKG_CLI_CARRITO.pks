CREATE OR REPLACE PACKAGE PKG_CLI_CARRITO AS
  ...
  PROCEDURE CARRITO_AGREGAR_DETALLE(p_carrito IN NUMBER, p_hist_precio IN NUMBER, p_cantidad IN NUMBER, p_id OUT NUMBER);
  ...
  PROCEDURE CARRITO_RESUMEN(p_data OUT SYS_REFCURSOR);
END PKG_CLI_CARRITO;
/