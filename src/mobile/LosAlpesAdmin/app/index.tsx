    ...
    <ScrollView style={styles.container}>
      <View style={styles.banner}>
        <View>
          ...
          <Text style={styles.bannerSub}>
            Muebles Los Alpes — Santos & Familia, Desde 1978
          </Text>
      ...
      <View style={styles.modGrid}>
        ...
        >
          ...
          <View style={styles.modBody}>
            ...
            <Text style={styles.modDesc}>
              Productos, categorías, materiales, almacenes y nichos.
            </Text>
          </View>
        ...
        >
          ...
          <View style={styles.modFoot}>
            <Text style={[styles.modLink, { color: "#2d7a2d" }]}>
              Gestionar →
            </Text>
          </View>
        </TouchableOpacity>
        ...
        >
          ...
          <View style={styles.modBody}>
            ...
            <Text style={styles.modDesc}>
              Ventas, facturas y reportes gerenciales.
            </Text>
          </View>
          <View style={styles.modFoot}>
            <Text style={[styles.modLink, { color: "#c53030" }]}>
              Gestionar →
            </Text>
          </View>
        </TouchableOpacity>
