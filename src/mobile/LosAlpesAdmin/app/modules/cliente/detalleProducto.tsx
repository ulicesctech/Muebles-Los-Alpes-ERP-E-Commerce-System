...
export default function DetalleProductoScreen() {
  ...
  if (loading)
    return <ActivityIndicator color={CAFE} style={{ marginTop: 40 }} />;
  ...
  const tienePromo =
    producto.PROM_PORCENTAJE !== null && producto.PROM_PORCENTAJE !== undefined;
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.imgCard}>
        {producto.FOTO_URL ? (
          <Image
            ...
            style={styles.img}
            resizeMode="cover"
            onError={() => console.log("Sin foto:", producto.PRO_REFERENCIA)}
          />
        ) : (
      ...
      <View style={styles.infoCard}>
        ...
        <Text style={styles.tipo}>
          {producto.TIP_DESCRIPCION} · {producto.MAT_DESCRIPCION}
        </Text>
        ...
        <View style={styles.precioWrap}>
          {tienePromo && (
            <Text style={styles.precioOriginal}>
              Q {Number(producto.PRO_PRECIO).toFixed(2)}
            </Text>
          )}
          <View style={styles.precioRow}>
            <Text
              style={[styles.precioFinal, tienePromo && styles.precioPromo]}
            >
        ...
        >
          <Text
            style={[
              styles.stockText,
              producto.STO_DISPONIBLE > 0
                ? styles.stockTextoDisp
                : styles.stockTextoAgot,
            ]}
          >
        ...
        <View style={styles.qtyWrap}>
          ...
          <TouchableOpacity
            style={styles.qtyBtn}
            onPress={() => setCantidad(Math.min(99, cantidad + 1))}
          >
            <Text style={styles.qtyBtnText}>+</Text>
          </TouchableOpacity>
        </View>
        ...
        <TouchableOpacity
          style={[
            styles.btnAgregar,
            producto.STO_DISPONIBLE <= 0 && styles.btnAgregarDisabled,
          ]}
...
const styles = StyleSheet.create({
  ...
  sinFotoIcon: { fontSize: 80, color: "#e8d8c0" },
  infoCard: {
    backgroundColor: "white",
    margin: 16,
    marginTop: 0,
