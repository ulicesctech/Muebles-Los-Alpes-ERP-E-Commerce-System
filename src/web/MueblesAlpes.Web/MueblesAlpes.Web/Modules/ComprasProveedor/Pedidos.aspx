            ...
            <div class="table-card">
                <asp:GridView ID="gvPedidos" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="160px" ItemStyle-VerticalAlign="Top">
                            <ItemTemplate>
    ...
    <asp:Panel ID="pnlDetalleContenedor" runat="server" Visible="false">
        <div class="form-card" style="border-top:4px solid #8B5E3C;">
            ...
            <div class="form-card-body">
                ...
                <%-- Datos de cabecera del pedido seleccionado --%>
                ...
                <!-- Grid productos con edicion inline -->
                <div class="table-card">
