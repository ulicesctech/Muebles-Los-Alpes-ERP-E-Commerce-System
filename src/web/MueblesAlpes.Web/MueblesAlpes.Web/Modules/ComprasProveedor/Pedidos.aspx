<%@ Page Language="VB" AutoEventWireup="true" CodeBehind="Pedidos.aspx.vb" Inherits="MueblesAlpes.Web.Modules.ComprasProveedor.Pedidos" MasterPageFile="~/Site.Master" ResponseEncoding="utf-8" ContentType="text/html; charset=UTF-8" %>
...
<div class="breadcrumb-mod">
    ...
    <a href='<%: ResolveUrl("~/Modules/ComprasProveedor/Index.aspx") %>'>💳 Cuentas proveedor</a> /
...
<div class="form-card">
    <div class="form-card-head">
        <span>✏️ <asp:Label ID="lblTituloForm" runat="server" Text="Nuevo Pedido"></asp:Label></span>
    </div>
    <div class="form-card-body">
        ...
        <div class="f-row">
            <div class="f-group">
                ...
                <asp:TextBox ID="txtCodigo" runat="server" CssClass="form-control" MaxLength="50" placeholder="Ej: PED-2026-001"></asp:TextBox>
            </div>
            <div class="f-group">
                <label>Forma de Pago</label>
                <asp:DropDownList ID="ddlFormaPago" runat="server" CssClass="form-control">
                    <asp:ListItem Value="CONTADO"       Text="Contado" />
                    <asp:ListItem Value="CREDITO"       Text="Crédito" />
                    <asp:ListItem Value="TRANSFERENCIA" Text="Transferencia" />
                    <asp:ListItem Value="SIMULADO"     Text="Simulado (otros)" />
                </asp:DropDownList>
            </div>
            <div class="f-group" id="divTotal" runat="server">
                <label>Total del Pedido (Q)</label>
                <asp:TextBox ID="txtTotal" runat="server" CssClass="form-control" placeholder="0.00" TextMode="Number" step="0.01"></asp:TextBox>
                <div class="note-auto">La fecha y el ID se generan al guardar.</div>
            </div>
        </div>
...
<div class="search-bar">
    <div class="search-wrap">
        ...
        <asp:TextBox ID="txtBuscar" runat="server" placeholder="Buscar por código (no distingue mayúsculas)..."></asp:TextBox>
    </div>
...
<div class="table-card">
    <asp:GridView ID="gvPedidos" runat="server" AutoGenerateColumns="false" CssClass="table"
                  OnRowCommand="gvPedidos_RowCommand" GridLines="None">
        <Columns>
            <asp:TemplateField HeaderText="ID" ItemStyle-Width="70px">
                <ItemTemplate><span class="badge-id"><%# Eval("PED_PEDIDO") %></span></ItemTemplate>
            </asp:TemplateField>
            <asp:BoundField DataField="PED_CODIGO"     HeaderText="Código" />
            <asp:BoundField DataField="PED_FECHA"      HeaderText="Fecha"  DataFormatString="{0:dd/MM/yyyy}" />
            <asp:TemplateField HeaderText="Forma Pago">
                <ItemTemplate><span class="badge-pago"><%# Eval("PED_FORMA_PAGO") %></span></ItemTemplate>
            </asp:TemplateField>
            <asp:BoundField DataField="PED_TOTAL" HeaderText="Total (Q)" DataFormatString="{0:N2}" ItemStyle-HorizontalAlign="Right" />
        ...
        <EmptyDataTemplate>
            <div class="empty-state"><div class="ei">📋</div><p>No hay pedidos registrados.</p></div>
        </EmptyDataTemplate>
    </asp:GridView>
</div>
</asp:Content>