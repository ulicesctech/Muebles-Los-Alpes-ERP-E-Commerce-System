<%@ Page Title="Grupos de Usuario" Language="VB" MasterPageFile="~/Site.Master" 
    AutoEventWireup="true" CodeFile="GrupoUsuario.aspx.vb" 
    Inherits="MueblesAlpes.Web.Modules.AuthUsuarios.Admin.GrupoUsuario" %>
...
<div class="page-title">👥 Gestión de Grupos de Usuario</div>
...
<div class="table-card">
    <asp:GridView ID="gvGrupos" runat="server" AutoGenerateColumns="false"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="grupus_descripcion" HeaderText="Descripción" />
            <asp:BoundField DataField="per_permisos"       HeaderText="ID Permiso" />
                ...
                <ItemTemplate>
                    <div class="actions-cell">
                        <asp:LinkButton runat="server" Text="✏️"
                            CommandName="Editar"
                            CommandArgument='<%# Eval("grupus_grupo_usuario") %>'
                            CssClass="btn-edit-t" />
