<%@ Page Title="Login Cliente" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="LoginCliente.aspx.vb" 
    Inherits="MueblesAlpes.Web.Modules.AuthUsuarios.LoginCliente" %>
...
<div class="breadcrumb-mod">
    ...
    <strong style="color:#5C3A1E;">Login Cliente</strong>
</div>

<div class="page-title">🛒 Gestión de Login Clientes</div>
...
<div class="tabs">
    ...
    <button class="tab-btn"        onclick="showTab('tabValidar', this)">🔒 Autenticar</button>
</div>

<!-- TAB: CREAR -->
<div id="tabCrear" class="tab-panel active">
    <div class="form-card">
        <div class="form-card-head"><span>➕ Crear Login de Cliente</span></div>
        <div class="form-card-body">
            <div class="form-group">
                <label>ID Cliente</label>
                <asp:TextBox ID="txtCrearId" runat="server" CssClass="form-control" placeholder="ID del cliente..." />
            </div>
            <div class="form-group">
                <label>Usuario</label>
...
<div id="tabActPass" class="tab-panel">
    <div class="form-card">
        ...
        <div class="form-card-body">
            <div class="form-group">
                <label>ID Cliente</label>
                <asp:TextBox ID="txtPassId" runat="server" CssClass="form-control" placeholder="ID del cliente..." />
            </div>
            <div class="form-group">
...
<div id="tabValidar" class="tab-panel">
    <div class="form-card">
        <div class="form-card-head"><span>🔒 Autenticar Cliente</span></div>
        <div class="form-card-body">
            <div class="form-group">
                <label>Usuario</label>
            ...
            <asp:Button ID="btnValidar" runat="server" Text="🔒 Autenticar"
...
<div class="table-card">
    <asp:GridView ID="gvLogins" runat="server" AutoGenerateColumns="false"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="logcli_usuario"      HeaderText="Usuario" />
        ...
        <EmptyDataTemplate>
            <div class="empty-state">
                ...
                <p>No hay logins de clientes registrados.</p>
            </div>
        </EmptyDataTemplate>
    </asp:GridView>
</div>
