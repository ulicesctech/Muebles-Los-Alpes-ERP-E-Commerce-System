    ...
    <div class="form-card-body">
        ...
        <div class="form-row-3">
            <div class="form-group">
                <label>Nombre *</label>
                <asp:TextBox ID="txtNombre" runat="server" CssClass="form-control" placeholder="Nombre del puesto..." />
            </div>
            <div class="form-group">
                <label>Salario *</label>
                <asp:TextBox ID="txtSalario" runat="server" CssClass="form-control" placeholder="Ej: 5000.00..." />
            </div>
            <div class="form-group">
...
<div class="table-card">
    <asp:GridView ID="gvPuestos" runat="server" AutoGenerateColumns="false"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="pue_salario"     HeaderText="Salario" DataFormatString="{0:C}" />
                ...
                <ItemTemplate>
                    <div class="actions-cell">
                        <asp:LinkButton runat="server" Text="✏️" CommandName="Editar"
                            CommandArgument='<%# Eval("pue_puestos") %>' CssClass="btn-edit-t" />
                        <asp:LinkButton runat="server" Text="🗑" CommandName="Eliminar"
                            CommandArgument='<%# Eval("pue_puestos") %>' CssClass="btn-del-t"
