...
<div class="breadcrumb-mod">
    ...
    <strong style="color:#5C3A1E;">Materiales</strong>
</div>
<div class="page-title">🧱 Gestión de Materiales</div>
<asp:Panel ID="pnlMsg" runat="server" Visible="false">
    <asp:Label ID="lblMsg" runat="server"></asp:Label>
</asp:Panel>
<div class="form-card">
    <div class="form-card-head">
        <span>✏️ <asp:Label ID="lblTituloForm" runat="server" Text="Nuevo Material"></asp:Label></span>
    </div>
...
<div class="table-card">
    <asp:GridView ID="gvMateriales" runat="server" AutoGenerateColumns="false" CssClass="table" OnRowCommand="gvMateriales_RowCommand" GridLines="None">
        ...
        <EmptyDataTemplate><div class="empty-state"><div class="ei">🧱</div><p>No hay materiales registrados.</p></div></EmptyDataTemplate>
    </asp:GridView>
</div>
</asp:Content>
