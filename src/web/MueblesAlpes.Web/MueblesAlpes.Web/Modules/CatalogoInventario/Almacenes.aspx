...
<div class="page-title">🏭 Gestión de Almacenes</div>
<asp:Panel ID="pnlMsg" runat="server" Visible="false">
    <asp:Label ID="lblMsg" runat="server"></asp:Label>
</asp:Panel>
<div class="form-card">
    <div class="form-card-head">
        <span>✏️ <asp:Label ID="lblTituloForm" runat="server" Text="Nuevo Almacén"></asp:Label></span>
    </div>
    <div class="form-card-body">
        ...
        <div class="f-row">
            ...
            <div class="f-group">
                <label>Ubicación <span style="color:#e53e3e;">*</span></label>
                <asp:TextBox ID="txtUbicacion" runat="server" CssClass="form-control" MaxLength="300" placeholder="Dirección exacta"></asp:TextBox>
            </div>
        </div>
...
<div class="table-card">
    <asp:GridView ID="gvAlmacenes" runat="server" AutoGenerateColumns="false" CssClass="table" OnRowCommand="gvAlmacenes_RowCommand" GridLines="None">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="200px">
                <ItemTemplate>
                    <div class="actions-cell">
                        <asp:LinkButton CommandName="Editar"   CommandArgument='<%# Eval("ALM_ALMACEN") %>' runat="server" CssClass="btn-edit-t">✏️ Editar</asp:LinkButton>
                        <asp:LinkButton CommandName="Eliminar" CommandArgument='<%# Eval("ALM_ALMACEN") %>' runat="server" CssClass="btn-del-t" OnClientClick="return confirm('¿Eliminar este almacén?');">🗑 Eliminar</asp:LinkButton>
                    </div>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
        <EmptyDataTemplate><div class="empty-state"><div class="ei">🏭</div><p>No hay almacenes registrados.</p></div></EmptyDataTemplate>
    </asp:GridView>
</div>
</asp:Content>
