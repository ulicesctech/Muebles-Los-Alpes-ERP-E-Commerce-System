<%@ Page Language="VB" AutoEventWireup="true" CodeBehind="Categorias.aspx.vb" Inherits="MueblesAlpes.Web.Modules.CatalogoInventario.Categorias" MasterPageFile="~/Site.Master" %>
...
<div class="breadcrumb-mod">
    ...
    <strong style="color:#5C3A1E;">Categorías</strong>
</div>
<div class="page-title">🏷️ Gestión de Categorías</div>
<asp:Panel ID="pnlMsg" runat="server" Visible="false">
    <asp:Label ID="lblMsg" runat="server"></asp:Label>
</asp:Panel>
<div class="form-card">
    <div class="form-card-head">
        <span>✏️ <asp:Label ID="lblTituloForm" runat="server" Text="Nueva Categoría"></asp:Label></span>
    </div>
    <div class="form-card-body">
        ...
        <div class="f-row">
            <div class="f-group">
                ...
                <asp:TextBox ID="txtDescripcion" runat="server" CssClass="form-control" MaxLength="200" placeholder="Ej: Sala, Dormitorio, Comedor..."></asp:TextBox>
            </div>
            ...
            <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="200px">
                <ItemTemplate>
                    <div class="actions-cell">
                        <asp:LinkButton CommandName="Editar"   CommandArgument='<%# Eval("CAT_CATEGORIA") %>' runat="server" CssClass="btn-edit-t">✏️ Editar</asp:LinkButton>
                        <asp:LinkButton CommandName="Eliminar" CommandArgument='<%# Eval("CAT_CATEGORIA") %>' runat="server" CssClass="btn-del-t" OnClientClick="return confirm('¿Eliminar esta categoría?');">🗑 Eliminar</asp:LinkButton>
                    </div>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
        <EmptyDataTemplate><div class="empty-state"><div class="ei">🏷️</div><p>No hay categorías registradas.</p></div></EmptyDataTemplate>
    </asp:GridView>
</div>
</asp:Content>
