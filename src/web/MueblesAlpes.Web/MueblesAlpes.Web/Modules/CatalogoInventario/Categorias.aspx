...
<asp:Content ID="cBody" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <asp:Label ID="lblTituloForm" runat="server" Text="Nueva Categoría"></asp:Label>
        </div>
    ...
    <div class="row" style="margin-bottom:10px;">
        <div class="col-sm-6">
            <div class="input-group">
                <asp:TextBox ID="txtBuscar" runat="server" CssClass="form-control" placeholder="Buscar por descripción..."></asp:TextBox>
    ...
    <asp:GridView ID="gvCategorias" runat="server"
        ...
        <Columns>
            <asp:BoundField DataField="CAT_CATEGORIA"   HeaderText="ID"          ItemStyle-Width="60px" />
            ...
            <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="160px" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <asp:LinkButton CommandName="Editar"   CommandArgument='<%# Eval("CAT_CATEGORIA") %>' runat="server" CssClass="btn btn-xs btn-warning">
                        <span class="glyphicon glyphicon-pencil"></span> Editar
                    </asp:LinkButton>&nbsp;
                    <asp:LinkButton CommandName="Eliminar" CommandArgument='<%# Eval("CAT_CATEGORIA") %>' runat="server" CssClass="btn btn-xs btn-danger"
