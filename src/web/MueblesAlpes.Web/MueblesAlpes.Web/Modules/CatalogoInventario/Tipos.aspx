...
<div class="breadcrumb-mod">
    ...
    <strong style="color:#5C3A1E;">Tipos</strong>
</div>
<div class="page-title">📋 Gestión de Tipos</div>
<asp:Panel ID="pnlMsg" runat="server" Visible="false">
    <asp:Label ID="lblMsg" runat="server"></asp:Label>
</asp:Panel>
<div class="form-card">
    <div class="form-card-head">
        <span>✏️ <asp:Label ID="lblTituloForm" runat="server" Text="Nuevo Tipo"></asp:Label></span>
    </div>
    <div class="form-card-body">
        ...
        <div class="f-row">
            <div class="f-group">
                ...
                <asp:TextBox ID="txtDescripcion" runat="server" CssClass="form-control" MaxLength="200" placeholder="Ej: Sofá, Mesa, Silla..."></asp:TextBox>
            </div>
            <div class="f-group">
                <label>Categoría <span style="color:#e53e3e;">*</span></label>
...
<div class="search-bar">
    <div class="search-wrap">
        <span class="search-icon-abs">🏷️</span>
        <asp:DropDownList ID="ddlFiltroCategoria" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlFiltroCategoria_SelectedIndexChanged" style="padding-left:14px;"></asp:DropDownList>
    </div>
</div>
            ...
            <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="200px">
                <ItemTemplate>
                    <div class="actions-cell">
                        <asp:LinkButton CommandName="Editar"   CommandArgument='<%# Eval("TIP_TIPO") %>' runat="server" CssClass="btn-edit-t">✏️ Editar</asp:LinkButton>
                        <asp:LinkButton CommandName="Eliminar" CommandArgument='<%# Eval("TIP_TIPO") %>' runat="server" CssClass="btn-del-t" OnClientClick="return confirm('¿Eliminar este tipo?');">🗑 Eliminar</asp:LinkButton>
                    </div>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
        <EmptyDataTemplate><div class="empty-state"><div class="ei">📋</div><p>No hay tipos registrados.</p></div></EmptyDataTemplate>
    </asp:GridView>
</div>
</asp:Content>
