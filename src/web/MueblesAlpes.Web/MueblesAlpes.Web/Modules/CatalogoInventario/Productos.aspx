...
.f-row-wrap { display:flex; gap:12px; flex-wrap:wrap; margin-bottom:12px; }
</style>
...
<div class="page-title">🛋️ Gestión de Productos</div>
<asp:Panel ID="pnlMsg" runat="server" Visible="false">
    <asp:Label ID="lblMsg" runat="server"></asp:Label>
</asp:Panel>
<div class="form-card">
    <div class="form-card-head">
        <span>✏️ <asp:Label ID="lblTituloForm" runat="server" Text="Nuevo Producto"></asp:Label></span>
    </div>
    <div class="form-card-body">
        ...
        <div class="f-row-wrap">
            <div class="f-group" style="max-width:160px;">
                <label>Referencia <span style="color:#e53e3e;">*</span></label>
                <asp:TextBox ID="txtReferencia" runat="server" CssClass="form-control" MaxLength="50" placeholder="MUE-001"></asp:TextBox>
            </div>
            <div class="f-group">
        ...
        <div class="f-row-wrap">
            ...
            <div class="f-group">
                <label>Tipo <span style="color:#e53e3e;">*</span></label>
                <asp:DropDownList ID="ddlTipo" runat="server" CssClass="form-control"></asp:DropDownList>
            </div>
            <div class="f-group">
                <label>Material <span style="color:#e53e3e;">*</span></label>
        ...
        <div class="f-row-wrap">
            ...
            <div class="f-group" style="max-width:150px;">
...
<asp:TemplateField HeaderText="Foto" ItemStyle-Width="90px">
    ...
    <ItemTemplate>
        ...
        <EmptyDataTemplate><div class="empty-state"><div class="ei">🛋️</div><p>No hay productos registrados.</p></div></EmptyDataTemplate>
    </asp:GridView>
</div>
</asp:Content>
